...
| `$creda-link` / `-tombstone` / `-disambiguate` / `-self-verify` / `$export`, Subscription, Bulk Data | 🚧 | Documented as not-yet-implemented (§8.2.5–8.2.14). Not registered → 404 if called. |
